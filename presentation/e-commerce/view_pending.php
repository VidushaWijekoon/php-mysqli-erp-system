...
<div class="row m-2">
    ...
    <div class="col-12 col-sm-6 col-md-3 mt-3 ">
        <a
            href="view_pending.php?start_time='<?php echo $date_1_start ?>'&end_time='<?php echo $date_1_end ?>'&day=Yesterday">
    ...
    <div class="col-12 col-sm-6 col-md-3 mt-3">
        <a
            href="view_pending.php?start_time='<?php echo $date_2_start ?>'&end_time='<?php echo $date_2_end ?>'&day=Day before yesterday">
    ...
    <div class="col-12 col-sm-6 col-md-3 mt-3">
        <a
            href="view_pending.php?start_time='<?php echo $date_3_start ?>'&end_time='<?php echo $date_3_end ?>'&day=2days ago">
            <div class="info-box">
                <span class="info-box-icon bg-info elevation-1"><i class="fa-solid fa-warehouse"></i></span>
                ...
                <tbody class="table-dark">
                    ...
                    <tr>
                        ...
                        <td class='text-center'>
                            ...
                            <a class='btn btn-xs bg-primary '><i class='fas fa-clock'></i>
                            </a>
                            <!-- <button type="button" class="btn btn-sm editbtn btn-info"><i
                                    class='fas fa-clock'></i></button> -->
                            <?php }elseif($data['order_status'] == 'order cancel'){ ?>
                            <a class='btn btn-xs bg-danger '><i class='fas fa-ban'></i>
                            </a>
                            <?php }else{ ?>
                            <a class='btn btn-xs bg-success '><i class='fas fa-circle-check'></i>
                            </a>
                            <?php } ?>
                        </td>
                    </tr>
