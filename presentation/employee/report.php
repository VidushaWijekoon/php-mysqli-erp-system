                        ...
                        <table id="tblexportData" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                if ($from_date != 0) {
                                    ...
                                    $query = "SELECT COUNT(qr_number)as qr_number_count,start_time,SUM(target)as target,user_id , department_id FROM performance_record_table WHERE status='1' AND end_time between '$from_date'AND '$to_date'GROUP BY user_id";
                                    $query_run = mysqli_query($connection, $query);
                                    ...
                                    foreach ($query_run as $data) {
                                        ...
                                        $reject = 0;
                                        $sql = "SELECT COUNT(reject_person)as reject_count FROM qc_paper WHERE reject_person='$user_id' ;";
                                ...
                                ?>
                                            ...
                                            href="report_per_person.php?from_date='<?php echo $from_date ?>'&to_date='<?php echo $to_date ?>'&user_id='<?php echo $user_id ?>'&count='<?php echo $data['qr_number_count'] ?>'"> -->
                                                ...
                                                <td>
                                                    <a href="day_summery.php?from_date='<?php echo $from_date ?>'&to_date='<?php echo $to_date ?>'&user_id='<?php echo $user_id ?>'&count='<?php echo $data['qr_number_count'] ?>'"><?php echo $data['qr_number_count'] ?></a>
                                                </td>
                                                <td>
