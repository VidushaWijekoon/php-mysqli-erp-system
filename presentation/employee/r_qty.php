                                ...
                                if (empty($query_run)) {
                                    ...
                                    foreach ($query_run as $a) {
                                        ...
                                        if ($bios_lock_hp == 'reject') {
                                            $reason = " bios lock hp ";
                                        } elseif ($bios_lock_dell == 'reject') {
                                            $reason = " bios lock dell";
                                        } elseif ($bios_lock_lenovo == 'reject') {
                                            $reason = "bios lock lenovo ";
                                        } elseif ($bios_lock_other == 'reject') {
                                            $reason = "bios lock other ";
                                        } elseif ($computrace_hp == 'active') {
                                            $reason = "computrace hp ";
                                        } elseif ($computrace_dell == 'active') {
                                            $reason = "computrace dell ";
                                        } elseif ($computrace_lenovo == 'lock') {
                                            $reason = "computrace lenovo ";
                                        } elseif ($computrace_other == 'lock') {
                                            $reason = "computrace other ";
                                        } elseif ($me_region_lock_hp == 'reject') {
                                            $reason = "me region lock hp ";
                                        } elseif ($tpm_lock_dell == 'reject') {
                                            $reason = "tpm lock dell ";
                                        } elseif ($other_error_lenovo == 'reject') {
                                            $reason = "other error lenovo ";
                                        } elseif ($other_error_other_brand == 'have') {
                                            $reason = "other error other brand ";
                                        } elseif ($a_top == 'have') {
                                            $reason = "a top ";
                                        } elseif ($b_bazel == 'reject') {
                                            $reason = " b bazel";
                                        } elseif ($c_palmrest == 'reject') {
                                            $reason = "c palmrest ";
                                        } elseif ($d_back_cover == 'reject') {
                                            $reason = "d back cover ";
                                        } elseif ($keyboard == 'reject') {
                                            $reason = " keyboard";
                                        } elseif ($lcd == 'reject') {
                                            $reason = "lcd ";
                                        } elseif ($webcam == 'reject') {
                                            $reason = "webcam ";
                                        } elseif ($mousepad_button == 'reject') {
                                            $reason = " mousepad button";
                                        } elseif ($mic == 'reject') {
                                            $reason = "mic ";
                                        } elseif ($speaker == 'reject') {
                                            $reason = "speaker ";
                                        } elseif ($wi_fi_connection == 'reject') {
                                            $reason = " wi-fi connection";
                                        } elseif ($usb == 'reject') {
                                            $reason = "usb ";
                                        } elseif ($battery == 'bad') {
                                            $reason = " battery";
                                        } elseif ($hinges_cover == 'reject') {
                                            $reason = "hinges cover ";
                                        } elseif ($user_id == 'reject') {
                                            $reason = "user id ";
                                        } elseif ($user_department == 'reject') {
                                            $reason = "user department ";
                                        } elseif ($rejection_department == 'reject') {
                                            $reason = "rejection department ";
                                        } elseif ($reject_person == 'reject') {
                                            $reason = "reject person ";
                                        } elseif ($power == 'reject') {
                                            $reason = " power";
                                        } elseif ($mb_display == 'reject') {
                                            $reason = " mb display";
                                        } elseif ($mb_other_issue == 'have') {
                                            $reason = "mb other issue ";
                                        } elseif ($bodywork == 'reject') {
                                            $reason = "bodywork ";
                                        } elseif ($sanding == 'reject') {
                                            $reason = "sanding ";
                                        } elseif ($ram == 'reject') {
                                            $reason = " ram";
                                        } elseif ($hard_disk_boot == 'not ok') {
