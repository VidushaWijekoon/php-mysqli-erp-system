...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-combine">
...
if(isset($_POST['combine_form'])){
    ...
    if($lunch_combine == 1){
    $query = "INSERT INTO combine_check (inventory_id, emp_id, sales_order_id, keyboard, speakers, camera, bazel, status, keys, mousepad, 
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <h4 class="modal-title">Combine Task</h4>
            ...
            <form method="POST">
                <div class="modal-body d-flex mx-5">
                    <div class="col col-md-6 col-lg-6">
                        ...
                        <div class="row">
                            <label class="col-sm-4 col-form-label text-capitalize">Keys</label>
                            <?php if($keys == null){ ?>
                            <div class="col-sm-8 mt-2">
                                <div class="icheck-success d-inline">
