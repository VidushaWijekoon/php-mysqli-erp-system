    ...
    <div class="row">
        <div class="col-lg-10 grid-margin stretch-card justify-content-center mx-auto">
            <div class="card-header bg-secondary">
                <h3 class="card-title p-2">Inventory ID <?php echo $_GET['inventory_id']; ?>
                </h3>
            </div>
    ...
    <?php 
        ...
        if(isset($_POST['motherboard_submit'])){
            ...
            if($bios_check == 1 || $power == 1 || $ports == 1){
                ...
                $query = "INSERT INTO motherboard_check (sales_order_id, emp_id, inventory_id, bios_check, power, ports, created_time, status, 	completed_time) 
                        VALUES ('$sales_order_id', '$emp_id', '$inventory_id', '$bios_check', '$power', '$ports', CURRENT_TIMESTAMP ,'$status', CURRENT_TIMESTAMP)";
                        echo $query;
        ...
        foreach($query_run_m as $mb_data){
            $bios = $mb_data['bios_check'];
            $power = $mb_data['power'];
            $ports = $mb_data['ports'];
            $mother_board_status = $mb_data['status'];
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
    ...
    $bazel = mysqli_real_escape_string($connection, $_POST['bazel_broken']);
    ...
    if($keyboard == 1 || $keys == 1 || $speakers == 1 || $camera ==1 || $bazel_broken ==1 || $mousepad == 1 || $mouse_pad_button == 1 || $camera_cable == 1 || $back_cover ==1 || $wifi_card ==1 || $lcd_cable == 1 || 
        $battery == 1 || $battery_cable == 1 || $dvd_rom ==1 || $dvd_caddy ==1 || $hdd_caddy == 1 || $hdd_cable_connector == 1 || $c_panel_palm_rest == 1 || $mb_base ==1 || $hings_cover ==1 || $lan_cover ==1 ||
        ...
        $query_6 = "INSERT INTO requested_part_from_production(brand, model, generation, sales_order_id, inventory_id, created_date, delivery_date, emp_id, location, status, keyboard, 
                                                                speakers, camera, bazel_broken, lan_cover, mousepad, mouse_pad_button, camera_cable, back_cover, wifi_card, lcd_cable, 
                                                                battery, battery_cable, dvd_rom, dvd_caddy, hdd_caddy, hdd_cable_connector, c_panel_palm_rest, mb_base, hings_cover, 
                                                                fan, heat_sink, cpu, switch, switch_id)
                    VALUES('$item_brand', '$item_model', '$item_generation', '$sales_order_id', '$inventory_id', '$date', CURRENT_TIMESTAMP ,'$emp_id', '$location10', '$status', '$keyboard', '$speakers',
    ...
    if($lunch_combine == 1){
        ...
        $combine_check_query = "INSERT INTO combine_check(inventory_id, emp_id, sales_order_id, keyboard, keyboard_keys, speakers, camera, bazel_broken, mousepad, mouse_pad_button, camera_cable, back_cover, wifi_card,
                                lcd_cable, battery, battery_cable, dvd_rom, dvd_caddy, hdd_caddy, hdd_cable_connector, c_panel_palm_rest, mb_base, hings_cover, lan_cover, fan, heat_sink, cpu, created_time, status, combined_id) 
                                VALUES('$inventory_id', '$emp_id', '$sales_order_id', '$keyboard', '$keyboard_keys', '$speakers', '$camera', '$bazel', '$mousepad', '$mouse_pad_button', '$camera_cable', 
        ...
        if($scan_id !=0){
            ...
            if( $test == 0){ 
                $query_in ="INSERT INTO combine_check(inventory_id, emp_id, sales_order_id, keyboard, speakers, camera, bazel, status, damage_keys, mousepad, mouse_pad_button, camera_cable, back_cover, wifi_card,
                    lcd_cable, battery, battery_cable, dvd_rom, dvd_caddy, hdd_caddy, hdd_cable_connector, c_panel_palm_rest, mb_base, hings_cover, lan_cover, combined_id )
                VALUES('$scan_id', '$emp_id', '$sales_order_id', '$keyboard1', '$speakers1', '$camera1', '$bazel1', '$status1', '$keys1', '$mousepad1', '$mouse_pad_button1', '$camera_cable1', '$back_cover1', '$wifi_card1',
                    '$lcd_cable1', '$battery1', '$battery_cable1', '$dvd_rom1', '$dvd_caddy1', '$hdd_caddy1', '$hdd_cable_connector1', '$c_panel_palm_rest1', '$mb_base1', '$hings_cover1', '$lan_cover1', '$inventory_id1' )";
                ...
                $query_update ="UPDATE combine_check SET keyboard = '$keyboard1', speakers = '$speakers1', camera = '$camera1', bazel = '$bazel1', status = '$status1', damage_keys = '$damage_keys1', mousepad = '$mousepad1',
                                                        mouse_pad_button = '$mouse_pad_button1', camera_cable = '$camera_cable1', back_cover = '$back_cover1', wifi_card = '$wifi_card1', lcd_cable = '$lcd_cable1', battery = '$battery1',
                                                        battery_cable = '$battery_cable1', dvd_rom = '$dvd_rom1', dvd_caddy = '$dvd_caddy1', hdd_caddy = '$hdd_caddy1', hdd_cable_connector = '$hdd_cable_connector1',
                                                        c_panel_palm_rest = '$c_panel_palm_rest1', mb_base = '$mb_base1', hings_cover = '$hings_cover1', lan_cover = '$lan_cover1', combined_id = '$combined_id1'
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form method="POST">
                    ...
                    <fieldset class="d-flex">
                        ...
                        <div class="col col-md-6 col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <?php }elseif($keyboard_keys == 1){ ?>
                                <div class="col-sm-8 mt-2">
                                    <div class="icheck-success d-inline">
                                        <input type="radio" id="c31" name="keyboard_keys" class="keys"
                                            value="keyboard_keys">
                                        <label class="label_values" for="c31" style="margin-right: 15px;">Okay </label>
                                    </div>
                                    <div class="icheck-danger d-inline">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mt-2">
                                    <div class="icheck-success d-inline">
                                        <input type="radio" id="13" name="bazel_broken" value="0">
                                        <label class="label_values" for="13" style="margin-right: 15px;">Okay </label>
                                    </div>
                                    <div class="icheck-danger d-inline">
                                        <input type="radio" id="r14" name="bazel_broken" value="1">
                                        <label class="label_values" for="r14">No </label>
                                    </div>
                                </div><?php }elseif($bazel==0){ ?>
                                <div class="col-sm-8 mt-2">
                                    <div class="icheck-success d-inline">
                                        <input type="radio" id="13" name="bazel_broken" value="0" checked="checked">
                                        <label class="label_values" for="13" style="margin-right: 15px;">Okay </label>
                                    </div>
                                    <div class="icheck-danger d-inline">
                                        <input type="radio" id="r14" name="bazel_broken" value="1" disabled>
                                        <label class="label_values" for="r14">No </label>
                                    </div>
                                </div><?php }elseif($bazel ==1){ ?>
                                <div class="col-sm-8 mt-2">
                                    <div class="icheck-success d-inline">
                                        <input type="radio" id="13" name="bazel_broken" class="bazel" value="bazel">
                                        <label class="label_values" for="13" style="margin-right: 15px;">Okay </label>
                                    </div>
                                    <div class="icheck-danger d-inline">
                                        <input type="radio" id="r14" name="bazel_broken" value="1" checked="checked">
                                        <label class="label_values" for="r14">No </label>
                                    </div>
                                    <div id="result"></div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mt-2">
                                    ...
                                    <div class="icheck-danger d-inline">
                                        ...
                                        <label class="label_values" for="combine43">No
                                        </label>
                                    </div>
                                </div>
                                <?php } elseif($lan_cover == 0){ ?>
                                ...
                                <div class="col-sm-8 mt-2">
                                    ...
                                    <div class="icheck-danger d-inline">
                                        <input type="radio" id="combine43" name="fan" value="fan" checked="checked">
                                        <label class="label_values" for="combine43">No
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mt-2">
                                    ...
                                    <div class="icheck-danger d-inline">
                                        ...
                                        <label class="label_values" for="combine45">No
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mt-2">
                                    ...
                                    <div class="icheck-danger d-inline">
                                        ...
                                        <label class="label_values" for="combine47">No
                                        </label>
                                    </div>
                                </div>
                                <?php } elseif($cpu == 0){ ?>
                ...
                <div class="modal-footer">
                    <button type="submit" name="combine_form"
                        class="btn btn-default btn-next bg-gradient-success">Next</button>
                </div>
            </form>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">03 LCD Form</h4>
            </div>
            <form method="POST">
                <div class="modal-body">
                    <fieldset style="display: block;">
                ...
                <div class="modal-footer">
                    <button type="submit" name="lcd_form"
                        class="btn btn-default btn-next bg-gradient-success">Next</button>
                </div>
            </form>
        </div>
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
    ...
    $status = 0;
    if($a_scratch == 1 || $a_broken == 1 || $a_dent == 1 || $b_scratch ==1 || $b_broken ==1 || $b_logo == 1 || $b_color == 1 || $c_scratch == 1 || 
        $c_broken ==1 || $c_dent ==1 || $d_scratch == 1 || $d_broken == 1 || $d_dent==1){
        $status = 1;
    } 
    $checkBox = implode(',', $_POST['work']);
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-footer">
                    <button type="submit" name="bodywork"
                        class="btn btn-default btn-next bg-gradient-success">Next</button>
                </div>
            </form>
        </div>
...
<div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">05 Production Check Form</h4>
            </div>
            <form method="POST">
                <div class="modal-body">
                    <fieldset style="display: block;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="icheck-success d-inline">
                                    ...
                                    <label class="label_values" for="celeron" style="margin-bottom: 5px;">Celeron
                                    </label>
                                </div>
                                <div class="icheck-success d-inline">
                                    <input type="radio" id="pentium" name="processor" value="pentium">
                                    <label class="label_values" for="pentium" style="margin-bottom: 5px;">Pentium
                                    </label>
                                </div>
                                <div class="icheck-success d-inline">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="icheck-success d-inline">
                                    ...
                                    <label class="label_values" for="1gb-graphic" style="margin-right: 15px;">1GB
                                    </label>
                                </div>
                                <div class="icheck-success d-inline">
                                    <input type="radio" id="2gb-graphic" name="graphic" value="2GB">
                                    <label class="label_values" for="2gb-graphic" style="margin-right: 15px;">2GB
                                    </label>
                                </div>
                                <div class="icheck-success d-inline">
                                    <input type="radio" id="4gb-graphic" name="graphic" value="4GB">
                                    <label class="label_values" for="4gb-graphic" style="margin-right: 15px;">4GB
                                    </label>
                                </div>
                                <div class="icheck-success d-inline">
                                    <input type="radio" id="8gb-graphic" name="graphic" value="8GB">
                                    <label class="label_values" for="8gb-graphic" style="margin-right: 15px;">8GB
                                    </label>
                                </div>
                                <div class="icheck-success d-inline">
                                    <input type="radio" id="16gb-graphic" name="graphic" value="16GB">
                                    <label class="label_values" for="16gb-graphic" style="margin-right: 15px;">16GB
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="icheck-success d-inline">
                                    ...
                                    <label class="label_values" for="Windows" style="margin-right: 15px;">Windows
                                    </label>
                                </div>
                                <div class="icheck-success d-inline">
