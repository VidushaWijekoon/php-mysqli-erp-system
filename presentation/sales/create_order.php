...
if(isset($_POST['get_custmer_details'])){
    ...
    header("Location: create_order.php?customer_id=$customer_id");
...
if(isset($_POST['add_items'])){
    ...
    $insert_items = "INSERT INTO sales_quatation_items(customer_id, device, brand, model, processor, core, generation, speed, lcd_size, resolution, touch_or_non_touch, hdd_capacity, hdd_type, ram, os, 
                                                    graphic_type, graphic_capacity, conditions, charger, packing_type, shipping_method, shipping_date, selling_type, qty, unit_price, discount, total, created_by)
                    VALUES ('$customer_table_customer_id', '$device', '$brand', '$model', '$processor', '$core', '$generation', '$speed', '$lcd_size', '$resolution', '$touch_or_non_touch',
                    '$hdd_capacity', '$hdd_type', '$ram', '$os', '$graphic_type', '$graphic_capacity', '$condition', '$charger', '$packing_type', '$shipping_method', '$shipping_date', '$selling_type',
                                    ...
                                    <div class="col-md-12 pl-5">
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            ...
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <select name="touch_or_non_touch" id="touch" class="info_select"
                                                        style="border-radius: 5px; width: 100%;">
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <input name="hdd_capacity" type="text" style="width: 100%;"
                                                        value="256">
                                                </div>
                                            </div>
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <select name="hdd_type" id="hdd_type" class="info_select"
                                                        style="border-radius: 5px; width: 100%;">
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <select name="ram" id="ram" class="info_select"
                                                        style="border-radius: 5px; width: 100%;">
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <select name="graphic_type" id="graphic_type" class="info_select"
                                                        style="border-radius: 5px; width: 100%;">
                                            ...
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <select name="graphic_capacity" id="graphic_capacity"
                                                        class="info_select" style="border-radius: 5px; width: 100%;">
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            ...
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <select name="charger" id="charger" class="info_select"
                                                        style="border-radius: 5px; width: 100%;">
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <select name="packing_type" id="packing_type" class="info_select"
                                                        style="border-radius: 5px; width: 100%;">
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <input type="date" style="width: 100%;" placeholder="Shipping Date"
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <input type="text" style="width: 100%;" placeholder="Enter Qty"
                                                        name="quantity" id="quantity" onblur="get_total()">
                                                </div>
                                            </div>
                                            <div class="row col-md-6">
                                                <div class="lableSec pt-2 col-md-3">
                                        ...
                                        <div class="row col-md-12 mt-4">
                                            ...
                                            <div class="row col-md-6">
                                                ...
                                                <div class="inputSec col-md-9">
                                                    <input type="text" style="width: 100%;" name="total" id="total">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-2 mb-5" style="width: 100%;">
                                        <button class="btn btn-success col-md-2 float-right" name="add_items"
                                            type="submit">Add
                                            Item</button>
                                    </div>
                                </fieldset>
        ...
        <form method="POST">
            <div class="modal-content">
                        ...
                        <table class="table table-dark text-uppercase" id="tbl">
                            ...
                            <tbody>
                                ...
                                foreach($qd as $qd){
                                    ...
                                    $shipping_date = $qd['shipping_date'];
                                    $charger = $qd['charger'];
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" name="create_quatation" class="btn btn-success">Create Order</button>
                </div>
            </div>
        </form>
    </div>
...
$(document).ready(function() {
    $("#resolution").on("change", function() {
        ...
        var getURL = "get_quatation_fields.php?resolution=" + resolution;
        console.log(getURL);
        $.get(getURL, function(data, status) {
            $("#touch").html(data);
        });
