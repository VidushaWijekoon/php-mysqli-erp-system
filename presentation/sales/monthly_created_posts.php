                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($result_set as $count){
                                    ...
                                    $posting_phone_number = $count['posting_contact_number'];
                            ...
                            <tr>
                                ...
                                <td><?php echo "+" . $posting_phone_number?></td>
                                ...
                                <td>
                                    <?php if($uae_pickup2 == 'yes') { echo "yes"; } elseif($uae_pickup2 == 'no') {echo "no"; } ?>
                                </td>
