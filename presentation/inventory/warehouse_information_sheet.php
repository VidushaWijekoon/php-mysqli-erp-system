                        ...
                        <form method="POST">
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" min="1" class="form-control" placeholder="Quantity" name="quantity">
                                    </div>
                                </div>
                                ...
                                <button type="submit" name="submit" id="submit" class="btn mb-2 mt-4 btn-primary btn-sm d-block mx-auto text-center"><i class="fa-solid fa-qrcode" style="margin-right: 5px;"></i>Genarate QR</button>
                ...
                <div class="card mt-3 w-100">
                    <div class="card-body">
                        ...
                        <div id="printableArea">
                            ...
                            if (empty($_SESSION['last_update_id'])) {
                                $last_update_id = 0;
                            } else {
