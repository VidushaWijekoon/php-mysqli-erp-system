...
<div class="row page-titles">
    <div class="col-md-5 align-self-center d-flex">
        ...
        <h3 class="mt-2">Keyboard Inventory</h3>
    </div>
</div>
<div class="row m-2">
    <div class="col-12 mt-3">
        ...
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="desktop.php"><i
                ...
                <a class="btn bg-gradient-info mx-2 text-white" type="button" href="charger.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Charger </span></a>
    </div>
</div>
<div class="row">
    <div class="col-lg-10 grid-margin stretch-card justify-content-center mx-auto mt-2">
        <div class="card mt-3">
            ...
            <div class="row m-2">
    <div class="col-12 mt-3">
            <a href="mix.php?type=Keyboard" class="btn btn-sm btn-success">Download  Excel
                file</a>
</div></div>
            <div class="card-body">
                <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $query="SELECT pallet_id,SUM(qty)as qty FROM pallet_informations WHERE category='Keyboard' GROUP BY pallet_id ORDER BY pallet_id ASC";
                        ...
                        foreach($query_run as $data){
                            ...
                            echo "<tr>";
                            ?>
                            <td><a href='keyboard_info.php?id=<?php echo $id ?>'><?php echo $id ?></a></td>
                            <?php
                            echo"<td>$qty</td>";
                            echo "</tr>";
                        }
