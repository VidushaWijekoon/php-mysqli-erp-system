...
<body class="alert-info text-dark">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center mt-2">
            <a href="../warehouse_dashboard.php"> Go back
                <i class="fa-solid fa-left fa-4x " style="color: red;"></i>
            </a>
        </div>
    </div>
            ...
            <div class="row">
                <div class="card col-md-4 offset-md-4 mt-5">
                    <div class="card-body text-center">
                        <h4>Battery Barcode Generator</h4>
                    </div>
                </div>
            </div>
            <div class="row">
...
?>
                            ...
                            <label for="" class="control-label d-none ">Code</label>
                            <input type="text" id="code" class="form-control d-none" value="<?php echo $now; ?>">
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label d-none">Label</label>
                            <input type="text" id="label" class="form-control  d-none">
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label d-none ">Barcode Type</label>
                        ...
                        <button type="button" class="col-md-2 btn-block btn btn-primary btn-sm"
