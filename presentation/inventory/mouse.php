...
<div class="row page-titles">
    <div class="col-md-5 align-self-center d-flex">
        ...
        <h3 class="mt-2">Mouse Inventory</h3>
    </div>
</div>
<div class="row m-2">
...
<div class="row">
    <div class="col-lg-10 grid-margin stretch-card justify-content-center mx-auto mt-2">
        <div class="card mt-3">
            ...
            <div class="row m-2">
    <div class="col-12 mt-3">
            <a href="mix.php?type=Mouse" class="btn btn-sm btn-success">Download  Excel
                file</a>
</div>
</div>
            <div class="card-body">
                <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $query="SELECT pallet_id,SUM(qty)as qty FROM pallet_informations WHERE category='Mouse' GROUP BY pallet_id ORDER BY pallet_id ASC";
                        ...
                        foreach($query_run as $data){
                            ...
                            echo "<tr>";
                            ?>
                            <td><a href='mouse_info.php?id=<?php echo $id ?>'><?php echo $id ?></a></td>
                            <?php
                            echo"<td>$qty</td>";
                            echo "</tr>";
                        }
