                ...
                <div class="card mt-3">
                    <div class="input-group mb-2 mt-2">
                        <form action="#" method="POST">
                            <input class="w-100" style="color:black !important" type="text" id="search" name="search" placeholder=" Search by Model">
                ...
                <tbody>
                    ...
                    foreach ($result_search as $data) {
                        ...
                        <tr>
                            ...
                            <td> <a href="./spec_view_by_core.php?brand=<?php echo $brand; ?>&model=<?php echo $model ?>&core=<?php echo $cpu ?>"><?php echo $model ?></a>
                            </td>
