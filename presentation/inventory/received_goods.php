...
foreach ($query_run as $data) {
        ...
        ?><tr>
                        ...
                        <form method='POST'>
                            <input type="text" name="id" value="<?php echo $inventory_id; ?>" class="d-none">
                            <input type="text" name="mfg" value="<?php echo $mfg; ?>" class="d-none">

                            <button type="submit" name="submit1" id="submit1"
                                class="btn btn-default bg-gradient-danger btn-next "> DELETE
                            </button>
                        </form>
                        <?php
}
