...
<div class="row m-2">
    <div class="col-12 mt-3">
        ...
        <a class="btn bg-gradient-secondary mx-2 text-white" type="button" href="team_member_records.php"><i
        ...
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="add_pending_machine_new_format.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Upload Shipment</span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="view_all_shipment_details.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">View All Shipment Details </span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="barcode/battery.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Battery Barcode Print </span></a>
    </div>
</div>
...
>>>>>>> 569552d40ee2f789411c7a1010ccfc478522bf45
    ...
    <div class="row m-2">
        <div class="col-12 mt-3">
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="machine_from_supplier.php"><i class="fa fa-plus"></i><span class="mx-1">Add Laptop</span></a>
            <a class="btn bg-gradient-warning mx-2 text-white" type="button" href="./warehouse_qr_report.php"><i class="fa-solid fa-qrcode"></i><span class="mx-1">Update Item</span></a>
            <a class="btn bg-gradient-primary mx-2 text-white" type="button" href="warehouse_stock_report.php"><i class="fa-solid fa-book"></i><span class="mx-1">Stock Report</span></a>
            <a class="btn bg-gradient-secondary mx-2 text-white" type="button" href="team_member_records.php"><i class="fa-solid fa-user"></i><span class="mx-1">Our Team</span></a>
            <a class="btn bg-gradient-success mx-2 text-white" type="button" href="warehouse_completed_task.php"><i class="fa-solid fa-check"></i><span class="mx-1">Completed Task</span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="add_pending_machine_new_format.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Upload Shipment</span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="view_all_shipment_details.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">View All Shipment Details </span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="barcode/battery.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Battery Barcode Print </span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="pallet_qr.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Pallet QR Print </span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="other_inventory.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Other Inventory </span></a>
...
>>>>>>> 569552d40ee2f789411c7a1010ccfc478522bf45
    ...
    <div class="row m-2">
        <div class="col-12 mt-3">
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="add_pallet.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Add to Pallet</span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="send_issues.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Audit</span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="mb_issue_list.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Motherboard Issue</span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="lcd_issue_list.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">LCD Issue</span></a>
            <a class="btn bg-gradient-info mx-2 text-white" type="button" href="fixed_pcs.php"><i class="fa-solid fa-layer-plus"></i><span class="mx-1">Audit Fixed Laptop</span></a>
        </div>
    </div>
