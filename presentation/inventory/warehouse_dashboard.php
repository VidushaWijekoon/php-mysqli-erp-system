    ...
    <div class="col-lg-10 grid-margin stretch-card justify-content-center mx-auto mt-2">
        <div class="card mt-3">
            <div class="card-header bg-secondary">
                <h6 class="text-uppercase m-0 p-0">Inverontry Sales Orders</h6>
            </div>
                    ...
                    <tbody class="tbody_1">
                        ...
                        <?php 
                                ...
                                $query = "SELECT *, SUM(item_quantity) AS No_of_Records 
                                        ...
                                        ORDER BY sales_order_created_date";
                        ...
                        <tr>
                            ...
                            <td><?php echo "<a class='btn btn-xs bg-teal'
