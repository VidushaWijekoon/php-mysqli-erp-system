...
<div class="row m-2">
    <div class="col-12 mt-3">
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="machine_from_supplier.php"><i
                class="fa fa-plus"></i><span class="mx-1">Add Laptop</span></a>
        ...
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="pallet_qr.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Pallet QR Print </span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="other_inventory.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Other Inventory </span></a>

    </div>
</div>
<div class="row m-2">
    <div class="col-12 mt-3">
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="add_pallet.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Add to Pallet</span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="send_issues.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Audit</span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="mb_issue_list.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Motherboard Issue</span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="lcd_issue_list.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">LCD Issue</span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="fixed_pcs.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Audit Fixed Laptop</span></a>
        <a class="btn bg-gradient-info mx-2 text-white" type="button" href="reverse.php"><i
                class="fa-solid fa-layer-plus"></i><span class="mx-1">Reverse Item</span></a>
    </div>
</div>
