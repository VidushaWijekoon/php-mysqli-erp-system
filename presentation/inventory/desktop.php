...
<div class="row">
    <div class="col-lg-10 grid-margin stretch-card justify-content-center mx-auto mt-2">
        <div class="card mt-3">
            ...
            <div class="row m-2">
    <div class="col-12 mt-3">
            <a href="other_unit.php" class="btn btn-sm btn-success">Download  Excel
                file</a>
</div>
</div>
            <div class="card-body">
                <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $query="SELECT pallet_id,SUM(qty)as qty FROM pallet_informations WHERE category='Desktop' GROUP BY pallet_id ORDER BY pallet_id ASC";
                        ...
                        foreach($query_run as $data){
                            ...
                            echo "<tr>";
                            ?>
                            <td><a href='desktop_info.php?id=<?php echo $id ?>s'><?php echo $id ?></a></td>
                            <?php
                            echo"<td>$qty</td>";
                            echo "</tr>";
                        }
