                    ...
                    <fieldset class="mt-2 mb-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 w-75">
                                ...
                                <form action="#" method="POST">
                                    <input class="w-50" style="color:black !important" type="text" id="search"
                                        name="search1" placeholder="Supplier Barcode OR MFG">
                        ...
                        <form action="#" method="POST">
                            ...
                            $query_update = "SELECT DISTINCT display_size AS lcd_size  ,screen_resolution FROM `screen_resolution` LEFT JOIN machine_from_supplier ON machine_from_supplier.model = screen_resolution.model WHERE screen_resolution.model='$model'";
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 w-75">
                                    ...
                                    <select name="brand" id="brand" class="form-control " style="border-radius: 5px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 w-75">
                                    ...
                                    <select name="series" id="series" class="form-control " style="border-radius: 5px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 w-75">
                                    ...
                                    <select name="model" id="model" class="form-control " style="border-radius: 5px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 w-75">
                                    ...
                                    <select name="core" id="core" class="form-control " style="border-radius: 5px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 w-75">
                                    ...
                                    <select name="speed" id="core" class="form-control " style="border-radius: 5px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 w-75">
                                    <?php if($exist == 'yes'){ ?>
                                    <select name="lcd_size" id="lcd_size" class="form-control "
                                        style="border-radius: 5px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 w-75">
                                    <?php if($exist == 'yes'){ ?>
                                    <select name="screen_resolution" id="screen_resolution" class="form-control "
                                        style="border-radius: 5px;">
