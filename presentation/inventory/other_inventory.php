...
<div class="row page-titles">
    <div class="col-md-5 align-self-center d-flex">
        ...
        <h3 class="mt-2">Monitor Inventory</h3>
    </div>
</div>
<div class="row m-2">
...
<div class="row">
    ...
    <div class="col-12 mt-3">
            <a href="other_unit_test.php" class="btn btn-sm btn-success">Download  Excel
                file</a>
</div></div>
            <div class="card-body">
                <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $query="SELECT pallet_id,SUM(qty)as qty FROM pallet_informations WHERE category='Monitor' GROUP BY pallet_id ORDER BY pallet_id ASC";
                        ...
                        foreach($query_run as $data){
                            ...
                            echo "<tr>";
                            ?>
                            <td><a href="monitor.php?id=<?php echo $id ?>"><?php echo $id ?></a></td>
                            <?php
                            echo"<td>$qty</td>";
                            echo "</tr>";
                        }
