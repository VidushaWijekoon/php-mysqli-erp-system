...
<div>
    <div class="row">
        <div class="col-lg-6 grid-margin stretch-card justify-content-center align-item-center mx-auto mt-2 text-uppercase">
            <div class="card mt-3">
                    ...
                    <form method='POST'>
                        <div class="row">
                            ...
                            <div class="col-sm-8 w-75">
                                <input class="w-50" style="color:black !important" type="number" name="qr_number" id="qr_number" placeholder="Scan QR number" required>

                            </div>
                        </div>
                        <button type="submit" name="submit" id="submit" class="btn mb-2 mt-4 btn-primary btn-sm  mx-auto text-center d-none">Confirm</button>
                    </form>
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card justify-content-center align-item-center mx-auto mt-2 text-uppercase">
                            <?php
                            $test = 0;
