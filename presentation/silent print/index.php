...
<body>
    ...
    <div id="msgInstallWCPP" style="display:none;">
        ...
        <p>
            <a href="http://www.neodynamic.com/downloads/wcpp/" target="_blank">Download and Install WCPP from
                Neodynamic website</a><br />
        </p>
        <h3>#2 After installing WCPP...</h3>
        <p>
            <a href="PrintHtmlCard.php">You can go and test the printing page</a>
        </p>
    ...
    function wcppDetectOnSuccess() {
        ...
        if (wcppVer.substring(0, 1) == "6")
            window.location.href = "PrintHtmlCard.php";
