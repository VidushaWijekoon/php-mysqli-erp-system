<?php 
  ...
  $title = 'WebClientPrint for PHP - Advanced PDF Printing';
...
<div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3><a href="Samples.php" class="btn btn-md btn-danger"><i class="fa fa-chevron-left"></i></a>&nbsp;Advanced PDF Printing</h3>
                <p>
                ...
                <div class="form-group well">
                    ...
                    <iframe id="ifPreview" style="width: 100%; height: 500px;" frameborder="0" src="//docs.google.com/gview?url=https://webclientprint.azurewebsites.net/files/mixed-page-orientation.pdf&embedded=true"></iframe>
...
<?php
    ...
    $demoPrintFilePDFControllerAbsoluteURL = substr($currentAbsoluteURL, 0, strrpos($currentAbsoluteURL, '/')).'/DemoPrintFilePDFController.php';
