                        ...
                        <div class="row">
                            <div class="col-sm-12 ">
                                ...
                                <label class="label_values my-1" for="xeon">Yes
                                    <input type="radio" id="cell2" name="cell" value="no" onclick="myFunction2()"
                                        checked>
...
<div class="modal fade " id="myModalFuck" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            <div class="modal-body ">
...
<div class="modal fade " id="myModalFuckSam" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            <div class="modal-body ">
                <div class="grid-margin  justify-content-center mx-auto mt-1">
                    <div class="row">
                        <div class="col-sm-12 ">
                            <h4 class="col-lg-8 ">Cell Change Complete Please Start Chargin </h4>
                        </div>
