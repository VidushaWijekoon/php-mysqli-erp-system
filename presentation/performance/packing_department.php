                        ...
                        <tbody>
                            <form method="POST">
                                <tr><?php
                                    ...
                                    ?>
                                    <td><input class="w-6" style="color:black !important" type="text" id="sales_order" name="sales_order" placeholder="salesorder " value="<?php echo $so ?>"></td>
                                    <td><input class="w-12" style="color:black !important" type="text" id="qr" name="box_num" placeholder=" box number " value="<?php echo $box ?>">
                                    </td>
                                    <td>
                                        <input class="w-75" style="color:black !important" type="text" id="wrapping_user" name="wrapping_user" placeholder=" Wrapping user here" value="<?php echo $name ?>">
                                    </td>
                                    <td><input class="w-75 " style="color:black !important" type="text" id="qr" name="qr" placeholder=" scan qr code here"></td>
                                    <!-- <td><input class="w-75" style="color:black !important" type="text" id="mfg"
                                            name="mfg" placeholder=" scan mfg code here"></td> -->
                                    <button type="submit" name="submit" id="submit" class="btn btn-default bg-gradient-success btn-next float-right d-none">
                                        Confirm
                                    </button>
                                </tr>
...
<div class="modal fade " id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            <div class="modal-header col-lg-12" style=" font-size: 30px;">
                Specification
            ...
            <div>
                <form method="POST">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input class="w-12" style="color:black !important" type="text" id="brand" name="brand" value="<?php echo $brand ?>" required readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input class="w-12" style="color:black !important" type="text" id="model" name="model" value="<?php echo $model ?>" required readonly>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 col-form-label">Core</label>
                        <div class="col-sm-10">
                            <input class="w-12" style="color:black !important" type="text" id="core" name="core" value="<?php echo $core ?>" required readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input class="w-12" style="color:black !important" type="text" id="generation" name="generation" value="<?php echo $generation ?>" required readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input class="w-12" style="color:black !important" type="text" id="screen_size" name="screen_size" value="<?php echo $screen_size ?>" required readonly>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 col-form-label">Screen Resolution</label>
                        <div class="col-sm-10">
                            <input class="w-12" style="color:black !important" type="text" id="screen_resolution" name="screen_resolution" value="<?php echo $screen_resolution ?>" required readonly>
                        </div>
                    </div>
                    ...
                    <button type="submit" name="submit_form" id="submit_form" class="btn btn-default bg-gradient-success btn-next float-right ">
                        Confirm
                    </button>
                    <button data-dismiss="modal" type="" name="cancel_form" id="cancel_form" class="btn btn-default bg-gradient-success btn-next float-right ">
                        Cancel
                    </button>
                </form>
            </div>
