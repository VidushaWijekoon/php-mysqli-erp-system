                            ...
                            <form method="POST">
                                <tr><?php 
                                    ...
                                    <td><input class="w-75 "
                                            ...
                                            style="color:black !important" type="text" id="qr" name="qr"
                                            placeholder=" scan qr code here"></td>
                    ...
                    <table id="tblexportData" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php $date1 = new DateTime('now', new DateTimeZone('Asia/Dubai'));
                                      ...
                                      $j=1;
                                      $spend_time =0;
                                    $query ="SELECT * FROM performance_record_table WHERE user_id=$user_id AND job_description ='packing scaned'AND start_time between '$date'AND '$date2' ORDER BY performance_id DESC";
                                    $query_run = mysqli_query($connection,$query);
...
$sales_order ='';
            if (isset($_POST['submit'])) {
                ...
                // $ram_capacity =$_POST['ram'];
                // $hdd_capacity =$_POST['hdd'];
                ...
                if($existing =='null' && $cartoon_number !=''){
                ...
                <form method="POST">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <label class="label_values my-1">HP
                                <input type="radio" id="brand" name="brand" value="HP"></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="radio" id="core" name="core" value="3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="radio" id="generation" name="generation" value="1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="radio" id="hard_type" name="hard_type" value="hdd">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="radio" id="hard_capacity" name="hard_capacity" value="120">
                            <label class="label_values my-1">160GB </label>
                            <input type="radio" id="hard_capacity" name="hard_capacity" value="160">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="radio" id="charger" name="charger" value="45w">
                            <label class="label_values my-1">65w yellow pin </label>
                            <input type="radio" id="charger" name="charger" value="65w yellow pin">
                            <label class="label_values my-1">65w  </label>
                            <input type="radio" id="charger" name="charger" value="65w">
                            <label class="label_values my-1">65w usb  </label>
                            <input type="radio" id="charger" name="charger" value="65w usb">
                            <label class="label_values my-1">90w yellow pin </label>
                            <input type="radio" id="charger" name="charger" value="90w yellow pin">
                            <label class="label_values my-1">90w </label>
                            <input type="radio" id="charger" name="charger" value="90w">
                            <label class="label_values my-1">90w USB </label>
                            <input type="radio" id="charger" name="charger" value="90w usb">
                            <label class="label_values my-1">135w </label>
                            <input type="radio" id="charger" name="charger" value="135w">
                            <label class="label_values my-1">135w yellow pin </label>
                            <input type="radio" id="charger" name="charger" value="135w yellow pin">
                            <label class="label_values my-1">135w usb </label>
                            <input type="radio" id="charger" name="charger" value="135w usb">
                            <label class="label_values my-1">180w </label>
                            <input type="radio" id="charger" name="charger" value="180w">
                            <label class="label_values my-1">240w </label>
                            <input type="radio" id="charger" name="charger" value="240w">
                    ...
                    <button type="submit" name="cancel_form" id="cancel_form"
                        class="btn btn-default bg-danger btn-next float-right ">
                        Cancel
                    </button>
                </form>
            </div>
